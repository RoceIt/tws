...
ALL_PARAMETERS = [TRADE_ID, ANNOUNCED, CW_POS, A, A_TIME, B, B_TIME,
                  C, C_TIME, MIN, MIN_TIME, MAX, MAX_TIME, XA,
                  ENTERED, STOPPED, MIN_IN_TRADE, MAX_IN_TRADE, RESULT,
                  CUMM_RESULT, LOOSING_STREAK, WINNING_STREAK, PERC_GOOD_TRADES,
...
def clean(trade_list):
    clean_list = [x for x in trade_list if x[MIN_IN_TRADE]>0]
    doubt_list = [x for x in trade_list if x[MIN_IN_TRADE]==0]
