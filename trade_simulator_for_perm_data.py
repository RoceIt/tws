...
class TradeSimulationByArgs():
    ...
    def up_swing_start(self):
        return self.up_swing_comp[0] if self.up_swing_comp else None
    
    @property
    def down_swing_start(self):
        return self.down_swing_comp[0] if self.down_swing_comp else None
    ...
    def save_minimal_restart_info(self, filename, location=mypy.TMP_LOCATION):
        ...
        info = (self.stoploss_handler, self.profit_handler,
                ...
                self.cap_stop, self.cap, self.reverse,
    ...
    def register(self, perm_lines):    
        ...
        for perm_line in perm_lines:
            ...
            #print('up', self.up_swing_comp, self.long_stop, "\n", 
                  #'down', self.down_swing_comp, self.short_stop)
    ...
    def register_perm_line(self, perm_line):
        ...
        if (not self.positions.in_trade() and            
            ...
            action = Action(0, 'nd', trade_direction, 1,
                      triad_exit_time, triad_exit_value, 
    ...
    def default_stoploss_handler(self, position, curr_ochl):
        ...
        return Action(id_, name, direction, size, time_, price, reason)
