...
def mif(name, base_data_filename, mess, auto_renew, verbose):
    ...
    def default_time_axis_end():
        ...
        return days['last_bar_nr'] + surplus
    ...
    day_zoom_lookback = timedelta(minutes=30)
    curr_zoom_start_end = [None, None]
    ...
    def show_base_bars(chart):
        chart.add_data_serie(name='base_bars',
            filename=std_if,
            fields=[1,3,4,5,6],
            style='financebars',
            linestyle='basebars',
    ...
    def show_upwave(chart):
        chart.add_data_serie(name="up_wave",
    ...
    def show_downwave(chart):
        chart.add_data_serie(name="down_wave",
    ...
    def show_moving_average(chart):
        chart.add_data_serie(name='moving_avg',
            filename=std_if,
            fields=[1,10],
            style='lines',
    ...
    def show_upper_band(chart):
        chart.add_data_serie(name='upper_band',
            filename=std_if,
            fields=[1,14],
            style='lines',
            linestyle='bolbolbol')
    ...
    def show_lower_band(chart):
        chart.add_data_serie(name='lower_band',
            filename=std_if,
            fields=[1,13],
            style='lines',
            linestyle='bolbolbol')
    ...
    def show_stoch(chart):
        chart.add_data_serie(name='stoch',
            filename=std_if,
            fields=[1,11],
            style='lines',
            linestyle='stoch')
    ...
    def zoom_time_axis(start, end):
        ...
        curr_zoom_start_end[0] = start
        curr_zoom_start_end[1] = end
        args['x_begin'] = start
        args['x_end'] = end
        i_canvas.zoom(**args)
...
def total_view(interval_names, name, mess):
    ...
    result_name = name
    #t_result_name = '{}ewq'.format(result_name)
    last_update = 0
    ...
    def create_total_view():
        ...
        #popen_args.append(t_result_name)
        popen_args.append(result_name)
        #popen_args.extend(['&&', 'mv', t_result_name, result_name])
        print(popen_args)
        Popen(popen_args)
