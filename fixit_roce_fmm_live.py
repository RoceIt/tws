...
def main():
    ...
    p_trader.fvita.export_file_base = "/tmp/fvita_live"
    ...
    print('starting live with: contract {}, datatset {}'.format(contract_t, dataset_ib_t))
    if continue_with_live_data:
...
def get_contract_info():
    ...
    menu.add_menu_item(
        "DAX FUTURE december 2014",
        return_value=(
            tws.contract_data("DAX-30_FUT1412"),
            "/home/rolcam/roce/Data/db/DAX FUT X25 20141219 EUR FDAX DEC 14@DTB.db",
            "TRADES", 
            "TRADES_5_secs",
            "0.5",
        ),
